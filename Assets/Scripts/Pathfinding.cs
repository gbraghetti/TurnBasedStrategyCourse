...
public class Pathfinding : MonoBehaviour {
    ...
    private void Awake() {
        ...
        gridSystem = new GridSystemHex<PathNode>(10, 10, 2f,
    ...
    public void Setup(int width, int height, float cellSize) {
        ...
        for (int x = 0; x < width; x++) {
            for (int z = 0; z < height; z++) {
                ...
                bool isAObstacle = Physics.Raycast(
        ...
        while (openList.Count > 0) {
            ...
            foreach (PathNode neighbourdNode in GetNeighbourList(currentNode)) {
                ...
                if (tentativeGCost < neighbourdNode.GetGCost()) {
                    ...
                    neighbourdNode.setHCost(CalculateHeuristicDistance(neighbourdNode.GetGridPosition(), endGridPosition));
